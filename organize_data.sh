...
#
# There will be the following error messages that can be safely ignored when this
# script is run:
# mv: rename data/N_sensitivity/numagents=50 to data/N_sensitivity/numagents=50/numagents=50: Invalid argument
# mv: rename data/N_sensitivity/numagents=200 to data/N_sensitivity/numagents=200/numagents=200: Invalid argument
# mv: rename data/nteachers_sensitivity/nteachers=20 to data/nteachers_sensitivity/nteachers=20/nteachers=20: Invalid argument
# mv: rename data/nteachers_sensitivity/nteachers=2 to data/nteachers_sensitivity/nteachers=2/nteachers=2: Invalid argument
# 
...
mkdir data/nteachers_sensitivity/nteachers={2,10,20}
...
mv data/nteachers_sensitivity/*nteachers=10* data/nteachers_sensitivity/nteachers=10
